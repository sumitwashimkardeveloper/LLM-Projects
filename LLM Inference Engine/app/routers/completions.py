...
async def create_completion(body: CompletionRequest, request: Request):
    ...
    metrics.record_request("/v1/completions")
    ...
    if not body.stream:
        ...
        metrics.record_latency("/v1/completions", elapsed * 1000)
        metrics.record_tokens("/v1/completions", completion_tokens, tokens_per_sec)
